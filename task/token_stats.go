...
// 		err = redis.Client.HSet("TOKENS_VOLUME_24H", token.Address, result.Volume24h.String()).Err()
// 		if err != nil {
// 			panic(err)
// 		}

// 		err = redis.Client.HSet("TOKENS_VOLUME_24H_CHANGE", token.Address, change).Err()
// 		if err != nil {
// 			panic(err)
// 		}
// 	}
...
// func UpdateTokenTraders() {
// 	log.Info("UpdateTokenTraders !!!")
// 	var tokens []models.Token
// 	models.DB.Find(&tokens)
